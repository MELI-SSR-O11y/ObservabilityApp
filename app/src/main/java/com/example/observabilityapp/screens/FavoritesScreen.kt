...
@Composable
fun FavoritesScreen(innerPaddingValues: PaddingValues, api: ContractObservabilityApi = koinInject()) {
  val onEvent = api::onEvent
  val screenName by remember { mutableStateOf(AppDestinations.FAVORITES.label) }
